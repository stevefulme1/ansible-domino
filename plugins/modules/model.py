...
"""Ansible module for managing Domino Data Lab model resources."""
...
---
module: model
short_description: Manage Domino model registrations
description:
    - Create, update, and delete Domino Data Lab model resources.
version_added: "1.0.0"
author:
...
options:
    ...
    model_version:
        description:
            - The model version for the Domino Data Lab resource.
        type: str
    state:
        description:
...
def needs_update(params, existing):
    ...
    check_fields = ['description', 'model_version']
