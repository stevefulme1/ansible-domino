...
"""Ansible module to query Domino Data Lab dataset resources."""
...
---
module: dataset_info
short_description: List or retrieve Domino datasets
description:
    - Retrieve information about Domino Data Lab dataset resources.
version_added: "1.0.0"
author:
...
options:
    ...
    dataset_id:
        description:
            - The dataset id for the Domino Data Lab resource.
        type: str
...
- name: List all datasets
  stevefulme1.domino.dataset_info:
...
def main():
    ...
    if params.get("project_id"):
        result = client.get(f"/api/v1/datasets/{params['project_id']}")
        module.exit_json(changed=False, datasets=[result] if result else [])
    else:
